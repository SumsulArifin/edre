  ...
  children: [
...

    {
      ...
      children: [
        ...
        ,
        // {
        //   name: 'Distributor Sales Representative (DSR)',
        //   to: '/master/distributorsalesrepresentative',
        //   active: true
        // },
        ...
        /*
        {
          ...
          children: [

            {
              ...
              to: '/organogram/divisionlhead',
              active: true
            },
            {
              name: 'Regionl Head',
              to: '/organogram/regionalhead',
              active: true
            },
            {
              name: 'Zonal Head',
              to: '/organogram/zonalhead',
              active: true
            },
            {
              name: 'Sales Officer',
              to: '/master/salesOfficer'
            }
          ]
        },
        */
        ...
        // {
        //   name: 'Target/Collection/Product Received/Evaluation',
        //   active: true,
        //   children: [
        //     {
        //       name: 'Time Pass',
        ...
        //     },
        //     {
        //       name: 'Distributor Product Received',
        //       to: '/master/dbproductreceived',
        //       active: true
        //     },
        //     {
        //       name: 'Distributor Primary Target Upload',
        //       to: '/master/dbprimarytargetupload',
        //       active: true
        //     },
        //     {
        //       name: 'Sales Representative Target',
        //       to: '/master/srtarget',
        //       active: true
        //     },
        //     {
        //       name: 'Distributor Primary Target',
        //       to: '/master/dbprimarytarget',
        //       active: true
        //     },
        //     {
        //       name: 'Distributor Daily Collection',
        //       to: '/master/dbdailycollection',
        //       active: true
        //     }
        //   ]
        // },
    ...
    //     },
    //     {
    //       name: 'Dealer Received Product',
    //       to: '/form/dealerreceived',
    //       active: true
    //     },
    //     {
    //       name: 'Dealer Product Adjustment',
    //       to: '/form/dealerproductadjustment',
    //       active: true
    //     }
    //     // {
    //     //   name: 'ECharts',
    ...
    // },
    // {
    //   name: 'Sales Order Secon.',
    //   icon: 'map',
    //   active: true,
    //   children: [
    //     {
    //       name: 'Order View & Memo Printout',
    //       to: '/maps/google-map',
    //       active: true
    //     },
    //     {
    //       name: 'SO/SR Movement Report',
    //       to: '/maps/leaflet-map',
    //       active: true
    //     },
    //     {
    //       name: 'Sales Order Summary & SKU Details - Outlet wise KPI',
    //       to: '/maps/leaflet-map',
    //       active: true
    //     }
    //   ]
    ...
    // },
    // {
    //   name: 'Regular/Major Sales Reports',
    //   active: true,
    //   icon: 'fire',
    //   children: [
    //     {
    ...
    // },
    // {
    //   name: 'Date Wise Full Month Reports',
    //   icon: 'poll',
    //   to: '/widgets',
    //   active: true
    // },
    ...
    // {
    //   name: 'Collection & Incentive Report',
    //   active: true,
    //   icon: 'shapes',
    //   children: [
    //     {
    ...
    // {
    //   name: 'Attendance & Payroll Report',
    //   icon: 'chart-line',
    //   active: true,
    //   children: [
    //     {
    ...
    // {
    //   name: 'Distributor Product Order Summary',
    //   icon: 'map',
    //   active: true,
    //   children: [
    //     {
