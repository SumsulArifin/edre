...
const CategoryType = () => {
    ...
    const DeleteCategoryType = id => {
        if (confirm('Are You Sure ?')) {
            ...
            axios
                .delete(
                    process.env.REACT_APP_BASE_URL + `categoryType/deleteBy/${id}`,
                    { headers: authHeader() }
                )
                .then(response => {
                    if (response) {
    ...
    */
    ...
    const columns = [
...

        {
            ...
            Cell: rowData => {
                const { categoryTypeId } = rowData.row.original;
                return (
                    <Dropdown className="d-inline mx-2">
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item href="">
                                ...
                                <Link to={`/master/categoryType/add/${categoryTypeId}`}><Button
                                    variant="light"
                                    size="sm"
                            ...
                            <Dropdown.Item href="">
                                ...
                                <Button
                                    variant="light"
                                    size="sm"
                                    onClick={() => DeleteCategoryType(categoryTypeId)}
                                >
                                    Delete
                                </Button>
                            </Dropdown.Item>
                ...
                <Card className="mb-3">
                    <Card.Header>
                        <CustomersTableHeader
                            title="Category Type"
                            newUrl='/master/categoryType/add'
                            data={categoryTypeData}
                            isFilter={false}
                            isExport={false}
                            table
